...
export default function CreateInvoiceProduct() {
  ...
  const handleSupplier = (value, id) => {
    setSupplierId(value);
    dispatch(updateSupplier(id));
  };
  ...
  return (
    <div className="w-full md:px-0 px-4 md:pr-8 flex flex-col pb-5 ">
      ...
      <div className="flex flex-col h-full w-full shadow-lg rounded-xl my-3">
        ...
        <div className=" bg-green-50 flex items-center overflow-auto  ">
                    ...
                    supplier.map((item, index) => {
                      return (
                        <MenuItem
                          key={index}
                          value={item.id}
                          onClick={() => handleSupplier(item.name, item.id)}
                        >
                          {item.name}
                        </MenuItem>
                      );
